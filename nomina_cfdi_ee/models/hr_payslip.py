...
class HrPayslip(models.Model):
    ...
    allowance_total_amount = fields.Monetary(compute="_get_total_amounts", string="Suma de percepciones", readonly=True)
    deduction_total_amount = fields.Monetary(compute="_get_total_amounts", string="Suma de deducciones", readonly=True)
    neto_total_amount = fields.Monetary(compute="_get_total_amounts", string="Neto a pagar", readonly=True)
    #############################################################
    ...
    def get_worked_day_lines(self, contracts, date_from, date_to):
        ...
        for contract in contracts.filtered(lambda contract: contract.resource_calendar_id):
            ...
            _logger.info("leave_days: " + str(leave_days))
